...
\tikz[scale=\scale]{
	...
	\pgfoonew \BC=new rrect(B,C,Ivory3,Ivory3,black,0.35,0.35,0.35,0.125);
	...
	\draw[latex-latex] (\ax-1.5cm,\cy)arc(180:140:1.5)node[midway, fill=white, inner sep=.3mm]{$40\degree$};
