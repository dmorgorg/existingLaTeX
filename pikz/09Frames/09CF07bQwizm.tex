...
\resizebox{0.75\textwidth}{!}{%
	\begin{tikzpicture}
        ...
        \RollerThree{A}{DarkSeaGreen4}{black}{0.6}{0.175}

        \begin{scope}[yshift=0.2cm]
            \DLDown{(\ax, \ay)}{(\bbx, \bby+2.5cm)}{(\bbx, \bby)}{LightBlue3}{black}{4}{1}{0.5}
            \DLDown{(\bbx, \bby+2.5cm)}{(\cx, \cy+1.5cm)}{(\cx, \cy)}{LightBlue3}{black}{8}{1}{0.5}
        \end{scope}
