...
\begin{tikzpicture}
    ...
    \draw[latex-latex] (\ax, \ay-1cm) -- (\bx, \by-1cm);
    \draw[latex-latex] (\bx, \ay-1cm) -- (\cx, \by-1cm);
    \draw[latex-latex] (\cx, \ay-1cm) -- (\dx, \by-1cm);
    \draw[latex-latex] (\ax-0.625cm, \ay) -- (\ax-0.625cm, \fy);
